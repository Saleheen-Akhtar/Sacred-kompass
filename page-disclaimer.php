 ...
 * 2. Add new file: page-disclaimer.php → paste this file
 * 3. Pages → Add New → Title: "Disclaimer" → Slug: disclaimer → Publish
 * 4. Add to footer: Appearance → Menus → Footer Menu → add this page
 */
get_header(); ?>
...
<section class="legal-hero">
  <div class="wrap">
    ...
    <h1><?php esc_html_e('Disclaimer','sacred-kompass'); ?></h1>
